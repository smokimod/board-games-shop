...
const ACTUAL_GAMES_DATA = "ACTUAL_GAMES_DATA";
...
export const actualReducer = (state = { data: [] }, action) => {
  switch (action.type) {
    case ACTUAL_GAMES_DATA:
      return action.payload.data;
    default:
      return state;
  }
...
export const getActualGames = (payload) => ({
  type: ACTUAL_GAMES_DATA,
  payload,
});
